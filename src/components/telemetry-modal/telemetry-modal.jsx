...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve blockzie',
        description: 'blockzie telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The blockzie Team is always looking to better understand how blockzie is used around the ' +
            'world. To help support this effort, you can allow blockzie to automatically send usage information to ' +
            'the blockzie Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the blockzie privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the blockzie Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the blockzie Team',
        description: 'Text for telemetry modal opt-in button',
                    ...
                    <p><FormattedMessage
                        ...
                        values={{
                            privacyPolicyLink: (<a
                                ...
                                href="https://blockzie.cc/privacy_policy/"
