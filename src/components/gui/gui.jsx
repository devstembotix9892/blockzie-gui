...
import PythonTab from '../../containers/PythonTab.jsx';
import JavascriptTab from '../../containers/javascriptTab.jsx';
                    ...
                    <Box className={styles.flexWrapper}>
                        <Box className={styles.editorWrapper}>
                            ...
                            >
                                ...
                                <TabPanel className={tabClassNames.tabPanel}>
                                    {pythonTabVisible ? <PythonTab
                                        vm={vm}
                                        onShowMessageBox={onShowMessageBox}
                                    /> : null}
                                </TabPanel>
                                <TabPanel className={tabClassNames.tabPanel}>
                                    {javascriptTabVisible ? <JavascriptTab
                                        vm={vm}
                                        onShowMessageBox={onShowMessageBox}
                                    /> : null}
                                </TabPanel>
...
GUIComponent.propTypes = {
    ...
    javascriptTabVisible: PropTypes.bool,
