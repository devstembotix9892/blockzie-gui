...
import {closeExtensionLibrary, openSoundRecorder, openConnectionModal,openTextModelModal,openClassifierModelModal, onOpenTrainModelModal, closeDeviceLibrary} from '../reducers/modals';
...
class Blocks extends React.Component {
    ...
    componentDidMount () {
        ...
        const trainModelEditButtonCallback = () => {
            this.props.onOpenTrainModelModal();
        };
        ...
        toolboxWorkspace.registerButtonCallback('EDIT_TRAIN_MODEL', trainModelEditButtonCallback);
    ...
    handleExtensionAdded (categoryInfo) {
        ...
        // blockzie-blocks implements a menu or custom field as a special kind of block ("shadow" block)
     ...
     * to the variable validation prompt callback used in blockzie-blocks.
     */
